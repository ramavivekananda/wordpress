        ...
        <div class="card-body">
          <div class="row justify-content-between pl5">
            <div class="col-12 col-md-5 justify-content-center">
                <p class="text-center" style="color:#5853d1; font-size:16px;">We are excited at the prospect of hosting you at <br />the HCL Lași, Romania Campus, for the Hackthon. <br />Please register if you are:</p>
                <p class="text-center"><img src="<?php echo $link;?>wp-content/uploads/2019/10/seattle-icon1.png" /><br />Azure DevOps Engineer</p>
                <p>&nbsp;</p>
                <p class="text-center"><img src="<?php echo $link;?>wp-content/uploads/2019/10/seattle-icon2.png" /><br />Data Bricks Engineer</p>
                <p>&nbsp;</p>
                      ...
                      <div class="row align-items-center">
                        <div class="col-12 mt-4">
							<!-- <input name="txtName" type="text" id="txtName" class="form-control formField" placeholder="Name *" />
							 ...
							 <?php if( function_exists( 'ninja_forms_display_form' ) ){ ninja_forms_display_form( 8 ); } else  ninja_forms_display_form( 1 );
							 ?>
                        </div>
                      </div>
					</div>
